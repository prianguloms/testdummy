...
function(_cppast_find_llvm_config)
    ...
    if(LLVM_DOWNLOAD_DIR)
        ...
        find_program(llvm_config_binary_no_suffix llvm-config PATHS "C:/LLVM/llvm-install/bin")
...
function(_cppast_find_libclang config_tool min_version force)
    ...
    if(NOT LIBCLANG_LIBRARY)
        ...
        find_library(LIBCLANG_LIBRARY NAMES clang libclang HINTS "${llvm_library_dir}" PATHS "C:/LLVM/llvm-project/clang/include")
    ...
    if(NOT CLANG_BINARY)
        ...
        find_program(CLANG_BINARY "clang" "${llvm_binary_dir}" PATHS "C:/Program Files (x86)/LLVM/bin")
